...
$app->get('/api/auth/authenticate/token/{provider}', [\Budgetcontrol\Gateway\Http\Controllers\AuthController::class, 'providerToken'])->add(\Budgetcontrol\Gateway\Http\Middleware\CachingMiddleware::class . ':1440');
$app->get('/api/auth/logout', [\Budgetcontrol\Gateway\Http\Controllers\AuthController::class, 'logout']);
$app->get('/api/auth/user-info/by-email/{email}', [\Budgetcontrol\Gateway\Http\Controllers\AuthController::class, 'getUserInfoByEmail'])->add(\Budgetcontrol\Gateway\Http\Middleware\AuthMiddleware::class)->add(\Budgetcontrol\Gateway\Http\Middleware\CachingMiddleware::class . ':1440');
