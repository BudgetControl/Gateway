...
$app->get('/api/auth/authenticate/token/{provider}', [\Budgetcontrol\Gateway\Http\Controllers\AuthController::class, 'providerToken'])->add(new \Budgetcontrol\Gateway\Http\Middleware\CachingMiddleware(1440));
