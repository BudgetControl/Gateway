...
\Illuminate\Support\Facades\Route::group(['middleware' => [\App\Http\Middleware\AuthMiddleware::class]], function () {
    ...
    \Illuminate\Support\Facades\Route::get('/stats/debits/total-negative', '\App\Http\Controllers\StatsController@debitsTotalNegative');
    \Illuminate\Support\Facades\Route::get('/stats/debits/total-positive', '\App\Http\Controllers\StatsController@debitsTotalPositive');
