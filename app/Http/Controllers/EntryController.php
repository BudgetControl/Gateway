...
class EntryController extends Controller {
    ...
    public function list(Request $request): Response
    {
        ...
        $response = $this->httpClient()->get("$basePath/$wsid".$this->entryType.$httpBuildQuery);
        $data = $response->json();
    ...
    public function show(Request $request, $uuid): Response
    {
        ...
        $wsid = Workspace::where('uuid', $body['token']['current_ws'])->first()->id;
        $basePath = $this->routes['entry'];
        $response = $this->httpClient()->get("$basePath/$wsid".$this->entryType."/$uuid");
        $data = $response->json();
    ...
    public function create(Request $request): Response
    {
        ...
        $wsid = Workspace::where('uuid', $body['token']['current_ws'])->first()->id;
        $basePath = $this->routes['entry'];
        $response = $this->httpClient()->post("$basePath/$wsid".$this->entryType,$body);
        $data = $response->json();
    ...
    public function update(Request $request, $uuid): Response
    {
        ...
        $wsid = Workspace::where('uuid', $body['token']['current_ws'])->first()->id;
        $basePath = $this->routes['entry'];
        $response = $this->httpClient()->put("$basePath/$wsid".$this->entryType."/$uuid",$body);
        $data = $response->json();
    ...
    public function delete(Request $request, $uuid): Response
    {
        ...
        $wsid = Workspace::where('uuid', $body['token']['current_ws'])->first()->id;
        $basePath = $this->routes['entry'];
        $response = $this->httpClient()->delete("$basePath/$wsid".$this->entryType."/$uuid");
        $data = $response->json();
