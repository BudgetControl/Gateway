...
class ChartsController extends StatsController {
    ...
    public function expensesCategoryBarByDate(Request $request): Response
    {
        ...
        $wsid = $body['token']['current_ws'];
        $basePath = $this->routes['stats'];
        $response = $this->httpClient()->get("$basePath/$wsid/chart/bar/expenses/category?".$request->getQueryString());
        $data = $response->json();
    ...
    public function expensesCategoryTableByDate(Request $request): Response
    {
        ...
        $wsid = $body['token']['current_ws'];
        $basePath = $this->routes['stats'];
        $response = $this->httpClient()->get("$basePath/$wsid/chart/table/expenses/category?".$request->getQueryString());
        $data = $response->json();
    ...
    public function expensesLabelBarByDate(Request $request): Response
    {
        ...
        $wsid = $body['token']['current_ws'];
        $basePath = $this->routes['stats'];
        $response = $this->httpClient()->get("$basePath/$wsid/chart/bar/expenses/label?".$request->getQueryString());
        $data = $response->json();
    ...
    public function incomingCategoryBarByDate(Request $request): Response
    {
        ...
        $wsid = $body['token']['current_ws'];
        $basePath = $this->routes['stats'];
        $response = $this->httpClient()->get("$basePath/$wsid/chart/bar/incoming/category?".$request->getQueryString());
        $data = $response->json();
    ...
    public function incomingCategoryTableByDate(Request $request): Response
    {
        ...
        $wsid = $body['token']['current_ws'];
        $basePath = $this->routes['stats'];
        $response = $this->httpClient()->get("$basePath/$wsid/chart/table/incoming/category?".$request->getQueryString());
        $data = $response->json();
    ...
    public function expensesLabelApplePieByDate(Request $request): Response
    {
        ...
        $wsid = $body['token']['current_ws'];
        $basePath = $this->routes['stats'];
        $response = $this->httpClient()->get("$basePath/$wsid/chart/apple-pie/expenses/label?".$request->getQueryString());
        $data = $response->json();
